...
<div class="main">
        <div class="card">
            <div class="image">
                <a href="admin_category.jsp?aid=<%=aid%>&pageno=1">
      ...
      <div class="card">
            <div class="image">
                <a href="manage_products.jsp?aid=<%=aid%>&pageno=1">
      ...
      <div class="card">
            <div class="image">
                <a href="admin_buyer.jsp?aid=<%=aid%>&pageno=1">
      ...
      <div class="card">
            <div class="image">
                <a href="admin_seller.jsp?aid=<%=aid%>&pageno=1">
      ...
      <div class="card">
            <div class="image">
                <a href="admin_feedback.jsp?aid=<%=aid%>&pageno=1">
