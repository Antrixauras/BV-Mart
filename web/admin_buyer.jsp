   ...
   <div class="icons">
    ...
    <div class="main">
        ...
        <table style="width:100%;padding:20px;border-style: groove;" border="5">
         ...
         <%
            try {
                ...
                String bid="",bname="",bemail="",bphone="",badd="";
                int i = 0;
                while(rst.next())
                {   i++;
                    if(i==startIndex)
        ...
        <% 
            ...
            rst.close();
               ResultSet rs2 = st.executeQuery("select count(*) from buyer");
               rs2.next();
               totalNumberOfRecords = rs2.getInt(1);
               bcount=totalNumberOfRecords;
               rs2.close();
...
%>
            <b><a href="admin_buyer.jsp?aid=<%=aid%>&pageno=<%=k%>"><%=k%></a>
                &nbsp;&nbsp;&nbsp;&nbsp;</b>
<%
        }
        } 
