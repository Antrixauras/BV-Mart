...
<html>
    ...
    <div class="register">
        <img src="images/logo.png" style= "width:150px; height:150px; border-radius:50%; margin-left: 130px" >
                ...
                <br>
                <input type="text" name="txt_uid" id="name" placeholder="Enter Admin-ID" required>
                <br><br>
...
try
{
        String aid=request.getParameter("txt_uid");
        String pwd=request.getParameter("txt_pass");
        String query="select * from admin where a_id='"+aid+"' and a_pass='"+pwd+"'";
        ...
        if(status)
        {
            ...
            <script>
                ...
                window.location= "admin_cardpage.jsp?aid=<%=aid%>";
             </script>
            <%
        }
        else
