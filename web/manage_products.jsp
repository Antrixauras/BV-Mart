...
<div class="main">
		 ...
		 ResultSet rst2 = st2.executeQuery("select p_id,p_name,p_image,p_status from product p INNER JOIN category c ON p.c_id=c.c_id and c.c_flag=0");
                rst3.next();
		count = rst3.getInt(1);
		rst3.close();
                if(count==0){
...
%>
            <b><a href="manage_products.jsp?aid=<%=aid%>&pageno=<%=k%>"><%=k%></a>
                &nbsp;&nbsp;&nbsp;&nbsp;</b>
<%
        }
        }               
