        ...
        %>  
            <tr>
                ...
                <td align="center"width="15%" style="padding:5px;font-size: 20px"><i><b><%=fdesc%></b></i></td>                
                 <td align="center" width="3%" style="padding:5px;"><a class="btn1" href="removefeedback.jsp?fid_=<%=fid%>&aid=<%=aid%>" onclick="return confirm('Are you sure?')">REMOVE</a></td>
...
%>
            <b><a href="admin_feedback.jsp?aid=<%=aid%>&pageno=<%=k%>"><%=k%></a>
                &nbsp;&nbsp;&nbsp;&nbsp;</b>
<%
        }
